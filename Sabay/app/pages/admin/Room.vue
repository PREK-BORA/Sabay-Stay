          ...
          <tbody class="divide-y divide-slate-200">
            <tr v-for="room in filteredRooms" :key="room.id" class="text-slate-700 hover:bg-slate-50 transition-colors">
              ...
              <td class="py-4 px-6 text-right space-x-2">
                ...
                <button @click="deleteRoomItem(room.id)" class="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-rose-600 bg-rose-50 rounded-lg hover:bg-rose-100 transition-colors border border-rose-300 cursor-pointer">
